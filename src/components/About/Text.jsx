...
const Text = () => {
  ...
  return (
    <motion.div variants={container} viewport={{ once: true, amount: 0.5 }} initial="hidden" whileInView="show" className='text'>
        ...
        <motion.h1 variants={item} className='text-3xl font-medium leading-10 mb-5'>DSA enthusiast & and can develop any any website you<br className='lg:block hidden' /> <span className='pink-text-gradient'>Want</span></motion.h1>
